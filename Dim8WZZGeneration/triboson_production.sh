...
GRIDPACK_BASE_URL=http://nuhep.northwestern.edu/~sapta/GridpacksDim8/Scale_ST
...
if [ "$CopyToEos" ]
then
xrdfs root://cmseos.fnal.gov mkdir /store/user/lpcvvv/ULSignalSamples/Dim6_${SAMPLE}_${LEPTONFILTER}_ReSubmit

echo ${SAMPLE}
echo ${LEPTONFILTER}
xrdcp -r -f ${STEP5_NAME}.root root://cmseos.fnal.gov//store/user/lpcvvv/ULSignalSamples/Dim6_${SAMPLE}_${LEPTONFILTER}_ReSubmit/
xrdcp -r -f ${STEP6_NAME}.root root://cmseos.fnal.gov//store/user/lpcvvv/ULSignalSamples/Dim6_${SAMPLE}_${LEPTONFILTER}_ReSubmit/
fi
