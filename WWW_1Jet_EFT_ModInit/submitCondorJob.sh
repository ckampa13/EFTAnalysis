...
SAMPLE=WWW_1Jet_xqcut50_ModEFTParam_Dim6_cW_cHd_cHWB_cHW_4F #WWW_1Jet_xqcut50
...
cat>Job_${1}.sh<<EOF
#!/bin/bash
sh triboson_production.sh -p pileup_files.txt -s ${SAMPLE} -c -o $PWD -a ${1} -n ${Nevents} -b \${2}\${3} -l NoFilter -f
EOF
