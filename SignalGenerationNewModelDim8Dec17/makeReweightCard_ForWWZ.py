...
FT3 = [-3.0e-11, -1.5e-11, -1e-11, -0.8e-11, -0.4e-11, -0.2e-11, 0.2e-11, 0.4e-11, 0.8e-11, 1e-11, 1.5e-11, 3.0e-11]
FT4 = [-3.0e-11, -1.5e-11, -1e-11, -0.8e-11, -0.4e-11, -0.2e-11, 0.2e-11, 0.4e-11, 0.8e-11, 1e-11, 1.5e-11, 3.0e-11]
...
total = len(FS0) + len(FS1) + len(FS2) + len(FM0) + len(FM1) + len(FM2) + len(FM3) + len(FM4) + len(FM5) + len(FM6) + len(FM7) + len(FT0) + len(FT1) + len(FT2) + len(FT3) + len(FT4) + len(FT5) + len(FT6) + len(FT7) 
...
for i in range(0, len(FM3)):
  ...
  file1.write(L[4])
  file1.write(L[5])
  file1.write("set anoinputs 7 " + str(FM3[i]) + " # FM3\n")
  file1.write(L[7])
  file1.write(L[8])
  file1.write(L[9])
  file1.write(L[10])
...
for i in range(0, len(FM4)):
  ...
  file1.write(L[5])
  file1.write(L[6])
  file1.write("set anoinputs 8 " + str(FM4[i]) + " # FM4\n")
  file1.write(L[8])
  file1.write(L[9])
  file1.write(L[10])
  file1.write(L[11])
...
for i in range(0, len(FM5)):
  ...
  file1.write(L[6])
  file1.write(L[7])
  file1.write("set anoinputs 9 " + str(FM5[i]) + " # FM5\n")
  file1.write(L[9])
  file1.write(L[10])
  file1.write(L[11])
  file1.write(L[12])
...
for i in range(0, len(FT3)):
  file1.write("\n")
  file1.write("\n")
  file1.write("#[" + str(i+1 + len(FS0)+len(FS1)+len(FS2)+len(FM0)+len(FM1)+len(FM6)+len(FM7)+len(FT0)+len(FT1)+len(FT2)) + "/" + str(total) + "] FT3:" + str(FT3[i])+"\n")
  if(FT3[i] < 0.0):
    file1.write("launch --rwgt_name=EFT__FT3_m"+"{:1.2g}".format(math.fabs(Fname[i]))+"\n")
  else:
    file1.write("launch --rwgt_name=EFT__FT3_p"+"{:1.2g}".format(math.fabs(Fname[i]))+"\n")
  file1.write(L[0])
  file1.write(L[1])
  file1.write(L[2])
  file1.write(L[3])
  ...
  file1.write(L[12])
  file1.write(L[13])
  file1.write("set anoinputs 15 " + str(FT3[i]) + " # FT3\n")
  file1.write(L[15])
  file1.write(L[16])
  file1.write(L[17])
  file1.write(L[18])
...
for i in range(0, len(FT4)):
  file1.write("\n")
  file1.write("\n")
  file1.write("#[" + str(i+1 + len(FS0)+len(FS1)+len(FS2)+len(FM0)+len(FM1)+len(FM6)+len(FM7)+len(FT0)+len(FT1)+len(FT2)+len(FT3)) + "/" + str(total) + "] FT4:" + str(FT4[i])+"\n")
  if(FT4[i] < 0.0):
    file1.write("launch --rwgt_name=EFT__FT4_m"+"{:1.2g}".format(math.fabs(Fname[i]))+"\n")
  else:
    file1.write("launch --rwgt_name=EFT__FT4_p"+"{:1.2g}".format(math.fabs(Fname[i]))+"\n")
  file1.write(L[0])
  file1.write(L[1])
  file1.write(L[2])
  file1.write(L[3])
  ...
  file1.write(L[13])
  file1.write(L[14])
  file1.write("set anoinputs 16 " + str(FT4[i]) + " # FT4\n")
  file1.write(L[16])
  file1.write(L[17])
  file1.write(L[18])
  file1.write(L[19])
...
for i in range(0, len(FT5)):
  file1.write("\n")
  file1.write("\n")
  file1.write("#[" + str(i+1 + len(FS0)+len(FS1)+len(FS2)+len(FM0)+len(FM1)+len(FM2)+len(FM3)+len(FM4)+len(FM5)+len(FM6)+len(FM7)+len(FT0)+len(FT1)+len(FT2)+len(FT3)+len(FT4)) + "/" + str(total) + "] FT5:" + str(FT5[i])+"\n")
  if(FT5[i] < 0.0):
  ...
  file1.write(L[14])
  file1.write(L[15])
  file1.write("set anoinputs 17 " + str(FT5[i]) + " # FT5\n")
  file1.write(L[17])
  file1.write(L[18])
  file1.write(L[19])
  file1.write(L[20])
...
for i in range(0, len(FT6)):
  file1.write("\n")
  file1.write("\n")
  file1.write("#[" + str(i+1 + len(FS0)+len(FS1)+len(FS2)+len(FM0)+len(FM1)+len(FM2)+len(FM3)+len(FM4)+len(FM5)+len(FM6)+len(FM7)+len(FT0)+len(FT1)+len(FT2)+len(FT3)+len(FT4)+len(FT5)) + "/" + str(total) + "] FT6:" + str(FT6[i])+"\n")
  if(FT6[i] < 0.0):
  ...
  file1.write(L[15])
  file1.write(L[16])
  file1.write("set anoinputs 18 " + str(FT6[i]) + " # FT6\n")
  file1.write(L[18])
  file1.write(L[19])
  file1.write(L[20])
...
for i in range(0, len(FT7)):
  file1.write("\n")
  file1.write("\n")
  file1.write("#[" + str(i+1 + len(FS0)+len(FS1)+len(FS2)+len(FM0)+len(FM1)+len(FM2)+len(FM3)+len(FM4)+len(FM5)+len(FM6)+len(FM7)+len(FT0)+len(FT1)+len(FT2)+len(FT3)+len(FT4)+len(FT5)+len(FT6)) + "/" + str(total) + "] FT7:" + str(FT7[i])+"\n")
  if(FT7[i] < 0.0):
  ...
  file1.write(L[16])
  file1.write(L[17])
  file1.write("set anoinputs 19 " + str(FT7[i]) + " # FT7\n")
  file1.write(L[19])
  file1.write(L[20])
