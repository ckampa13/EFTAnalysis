...
void makePlots_FT0()
{
  ...
  double param[7] = {-5.0, -2.0, -1.0, 0.0, 1.0, 2.0, 5.0};
  double yield_signal_FT0[7] = {69.439587, 17.60760, 0.72411242, 0.037298381, 0.74792664, 17.479831, 69.677729};
  ...
  TF1 *fit_yield = new TF1("fit_yield","[0]+[1]*x+[2]*x*x", -10.0, 10.0);
