...
void makePlots_FT0()
{
  ...
  double yield_signal_FT0_ST250[13] = {17.8, 5.52, 3.3, 2.64, 1.82, 1.62, 1.58, 1.68, 1.93, 2.88, 3.57, 5.96, 18.65};

  double yield_signal_FT0_ST1000[13] = {13, 3.3, 1.5, 0.97, 0.28, 0.11, 0.057, 0.12, 0.31, 1.00, 1.6, 3.4, 13} 
  ...
  std::cout << " yield_bkg[0] = " <<  yield_bkg[0] << std::endl;

  TGraph *gr = new TGraph(13, param, yield_signal_FT0_ST250);
