...
void makePlots_BW()
{
  ...
  double lumi = 137.0;
  double onshell_crosssection = 0.520165745296*1000.0;
  double onshell_crosssection_int = -1.03198518569e-05*1000.0; 
  double onshell_crosssection_bsm = 0.447301461*1000.0; //0.0068372*1000.0;//0.007216*1000.0
  double onshell_crosssection_sm = 0.073458606*1000.0; 

  TFile* filedim6All = new TFile("test_unweighted_events_WWW_dim6_cHd_All.root");
  ...
  TFile* filedim6Interference = new TFile("test_unweighted_events_WWW_dim6_cHd_Interference.root");
  ...
  TFile* filedim6BSM = new TFile("test_unweighted_events_WWW_dim6_cHd_BSM.root");
  ...
  leg1->SetFillStyle(0);
  leg1->SetHeader("C_{HD}/#Lambda^{2} = 50000 TeV^{-2}");
  ...
  c1.SaveAs("WWW_dim6_cHd_simpleComparison.png");
  c1.SaveAs("WWW_dim6_cHd_simpleComparison.pdf");
}
