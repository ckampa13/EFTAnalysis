...
void makePlots_BW()
{
  ...
  double lumi = 137.0;
  double onshell_crosssection = 0.03849629951*1000.0;
  double onshell_crosssection_int = 0.000867438234*1000.0; 
  double onshell_crosssection_bsm = 0.0072163*6.0*1000.0; //0.0068372*1000.0;//0.007216*1000.0
  double onshell_crosssection_sm = 0.112788441*1000.0; 

  TFile* fileOnshellAll = new TFile("test_unweighted_events_WWW_dim6_cHWB_BSM_DoubleInsertion.root");
  ...
  leg1->SetFillStyle(0);
  leg1->SetHeader("#splitline{c_{HWB}/#Lambda^{2} = 7 TeV^{-2} and}{F_{T0}/#Lambda^{4} = 1 TeV^{-4}}");
  ...
  c1.SaveAs("mass_elnu_BW_simpleComparison_QUADDim6VsDim8_cHWB.png");
  c1.SaveAs("mass_elnu_BW_simpleComparison_QUADDim6VsDim8_cHWB.pdf");
}
