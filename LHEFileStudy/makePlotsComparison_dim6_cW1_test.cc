...
void makePlots_BW()
{
  ...
  */
  ...
  TH1F *hdim6All = (TH1F*)filedim6All->Get("ST");
  hdim6All->SetTitle("");
  ...
  TH1F *hdim6BSM = (TH1F*)filedim6BSM->Get("ST");
  ...
  TH1F *hdim6SM = (TH1F*)filedim6SM->Get("ST");
  ...
  h_ratio->SetTitle("; #bf{S_{T} (GeV)}; Full/Sum Ratio");
