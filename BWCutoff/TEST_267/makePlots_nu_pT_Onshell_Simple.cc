...
void makePlots_BW()
{
  ...
  TH1F *hWWW_Onshell_BW1 = (TH1F*)fileWWW_Onshell_BW1->Get("h_nu_pT");
  ...
  hWWW_Onshell_BW1->GetXaxis()->SetTitle("Electron Neutrino pT [GeV]");
  ...
  TH1F *hWWW_Onshell_BW5= (TH1F*)fileWWW_Onshell_BW5->Get("h_nu_pT");
  ...
  TH1F *hWWW_Onshell_BW10= (TH1F*)fileWWW_Onshell_BW10->Get("h_nu_pT");
...
*/
  ...
  TFile* fileWWW_Onshell_BW15 = new TFile("test_sapta_15.root");
  TH1F *hWWW_Onshell_BW15 = (TH1F*)fileWWW_Onshell_BW15->Get("h_nu_pT");
  hWWW_Onshell_BW15->SetLineColor(kBlack);
  hWWW_Onshell_BW15->SetLineWidth(2);
  hWWW_Onshell_BW15->Rebin(5);
  hWWW_Onshell_BW15->Scale(offshell_crosssection*lumi/numberOfevents);
  ...
  hWWW_Onshell_BW15->GetXaxis()->SetRangeUser(0.0, 300.0);
  //if(hWWW_Onshell_BW15->Integral() > 0.0) hWWW_Onshell_BW15->Scale(1.0/hWWW_Onshell_BW15->Integral());
  //hWWW_Onshell_BW15->Scale(0.00574*lumi/numberOfevents);
  ...
  hWWW_Onshell_BW15->GetXaxis()->SetTitle("Electron Neutrino pT [GeV]");
  //hWWW_Onshell_BW15->GetXaxis()->SetTitle("#splitline{Mass of the W boson}{(electron + neutrino invariant mass) [GeV]}");
  //hWWW_Onshell_BW15->GetYaxis()->SetTitle("A.U.");
  //hWWW_Onshell_BW15->SetMaximum(1.0);
  hWWW_Onshell_BW15->SetMinimum(0.01);
  hWWW_Onshell_BW15->Draw("HIST");

  TFile* fileWWW_Onshell_BW100 = new TFile("test_WWWOnshell_bw100.root");
  TH1F *hWWW_Onshell_BW100 = (TH1F*)fileWWW_Onshell_BW100->Get("h_nu_pT");
  ...
  TH1F *hWWW_Onshell_BW100000 = (TH1F*)fileWWW_Onshell_BW100000->Get("h_nu_pT");
  hWWW_Onshell_BW100000->SetLineColor(kOrange-3);
  hWWW_Onshell_BW100000->SetLineWidth(2);
  hWWW_Onshell_BW100000->Rebin(5);
  hWWW_Onshell_BW100000->Scale(onshell_crosssection*lumi/numberOfevents);
  ...
  c1.SaveAs("h_nu_pT_Onshell_SimpleEventYields.png");
  c1.SaveAs("h_nu_pT_Onshell_SimpleEventYields.pdf");
}
