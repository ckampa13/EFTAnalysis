...
void makePlots_BW()
{
  ...
  TH1F *hWWW_Onshell_BW1 = (TH1F*)fileWWW_Onshell_BW1->Get("M_elnu");
  hWWW_Onshell_BW1->SetLineColor(kRed);
  hWWW_Onshell_BW1->SetLineWidth(2);
  hWWW_Onshell_BW1->Rebin(20);
  ...
  TH1F *hWWW_Onshell_BW5= (TH1F*)fileWWW_Onshell_BW5->Get("M_elnu");
  hWWW_Onshell_BW5->SetLineColor(kBlue);
  hWWW_Onshell_BW5->SetLineWidth(2);
  hWWW_Onshell_BW5->Rebin(20);
  ...
  TH1F *hWWW_Onshell_BW10= (TH1F*)fileWWW_Onshell_BW10->Get("M_elnu");
  hWWW_Onshell_BW10->SetLineColor(kGreen+3);
  hWWW_Onshell_BW10->SetLineWidth(2);
  hWWW_Onshell_BW10->Rebin(20);
  ...
  TH1F *hWWW_Onshell_BW100 = (TH1F*)fileWWW_Onshell_BW100->Get("M_elnu");
  hWWW_Onshell_BW100->SetLineColor(kMagenta);
  hWWW_Onshell_BW100->SetLineWidth(2);
  hWWW_Onshell_BW100->Rebin(20);
  ...
  TH1F *hWWW_Onshell_BW100000 = (TH1F*)fileWWW_Onshell_BW100000->Get("M_elnu");
  hWWW_Onshell_BW100000->SetLineColor(kOrange-3);
  hWWW_Onshell_BW100000->SetLineWidth(2);
  hWWW_Onshell_BW100000->Rebin(20);
  ...
  TFile* fileWWW_Onshell_BW100000_SF = new TFile("test_WWWOnshell_bw100000_SignFlipped.root");
  TH1F *hWWW_Onshell_BW100000_SF = (TH1F*)fileWWW_Onshell_BW100000_SF->Get("M_elnu");
  hWWW_Onshell_BW100000_SF->SetLineColor(kAzure+7);
  hWWW_Onshell_BW100000_SF->SetLineWidth(2);
  hWWW_Onshell_BW100000_SF->Rebin(20);
  //hWWW_Onshell_BW100000_SF->Scale(0.012605527586*lumi/numberOfevents);
  if(hWWW_Onshell_BW100000_SF->Integral() > 0.0) hWWW_Onshell_BW100000_SF->Scale(1.0/hWWW_Onshell_BW100000_SF->Integral());
  hWWW_Onshell_BW100000_SF->Draw("HIST SAME");
  ...
  leg1->SetFillStyle(0);
  leg1->AddEntry(hWWW_Onshell_BW1,"BW cutoff: 1","l");
  leg1->AddEntry(hWWW_Onshell_BW5,"BW cutoff: 5","l");
  leg1->AddEntry(hWWW_Onshell_BW10,"BW cutoff: 10","l");
  leg1->AddEntry(hWWW_Onshell_BW15,"BW cutoff: 15","l");
  leg1->AddEntry(hWWW_Onshell_BW100,"BW cutoff: 100","l");
  leg1->AddEntry(hWWW_Onshell_BW100000,"BW cutoff: 100000","l");
  leg1->AddEntry(hWWW_Onshell_BW100000_SF,"BW cutoff (sign flip): 100000","l");
  leg1->Draw();

  c1.SaveAs("mass_elnu_BW_Onshell_EventYield.png");
  c1.SaveAs("mass_elnu_BW_Onshell_EventYield.pdf");
}
