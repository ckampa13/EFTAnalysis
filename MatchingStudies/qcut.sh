...
FRAGMENT_BASE_URL=http://nuhep.northwestern.edu/~sapta/Qcut/
GRIDPACK_BASE_URL=http://nuhep.northwestern.edu/~sapta/Qcut_WW/

FRAGMENT=wmLHEGS-fragment-${YEAR}_${LEPTONFILTER}.py
GRIDPACK=${SAMPLE}_xqcut${XQCUT}_4F_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.xz
