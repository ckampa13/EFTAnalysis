...
# full analysis
def run_combine_full_analysis_leave_one_out(channel_leave_out, dim, WC1, WC2, ScanType, Asimov, asi_str, SignalInject,
...
if __name__=='__main__':
    ...
    for channel in channels:
        ...
        print('=================================================')
        run_combine_full_analysis_leave_one_out(channel, dim, WC1=args.WC1, WC2=args.WC2,
