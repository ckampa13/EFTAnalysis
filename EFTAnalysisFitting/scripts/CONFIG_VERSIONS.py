...
versions_dict = {
    ...
    '0Lepton_2FJ': {'v': 29, 'lumi': 'Run2', 'EFT_type': 'points', 'EFT_ops': dim6_WCs+dim8_WCs,
                    'v_NDIM': 29, 'EFT_ops_NDIM': dim6_WCs, 'v_TEMPLATE': 29, 'unblind': True}, # unblinding; parabolas debugged
    ...
    '1Lepton': {'v': 13, 'lumi': 'Run2', 'EFT_type': 'points', 'EFT_ops': dim6_WCs+dim8_WCs,
                'v_NDIM': 13, 'EFT_ops_NDIM': dim6_WCs, 'v_TEMPLATE': 13, 'unblind': True}, # unblinding; fixed missing overlap removal; JES fix
    ...
    '2Lepton_OS': {'v': 25, 'lumi': 'Run2', 'EFT_type': 'points', 'EFT_ops': dim6_WCs+dim8_WCs,
                   'v_NDIM': 25, 'EFT_ops_NDIM': dim6_WCs, 'v_TEMPLATE': 25, 'unblind': True}, # unblinding
    ...
    '2Lepton_OS_2FJ': {'v': 8, 'lumi': 'Run2', 'EFT_type': 'points', 'EFT_ops': dim6_WCs+dim8_WCs,
                       'v_NDIM': 8, 'EFT_ops_NDIM': dim6_WCs, 'v_TEMPLATE': 8, 'unblind': True}, #  unblinding, dim8 added
    ...
    '2Lepton_SS': {'v': 14, 'lumi': 'Run2', 'EFT_type': 'points', 'EFT_ops': dim6_WCs+dim8_WCs,
                   'v_NDIM': 14, 'EFT_ops_NDIM': dim6_WCs, 'v_TEMPLATE': 14, 'unblind': True}, # unblinding; JES fix
    ...
    '1Lepton_1T': {'v': 45, 'lumi': 'Run2', 'EFT_type': 'points', 'EFT_ops': dim6_WCs+dim8_WCs_1T,
                   'v_NDIM': 45, 'EFT_ops_NDIM': dim6_WCs, 'v_TEMPLATE': 45, 'unblind': True}, # unblinding; assigned updated; JES SM VVV bug fixed
