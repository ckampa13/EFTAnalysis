...
def check_file_threshold_2param(dcdir, rootfile, NLL_threshold, stepsize, stepsize_coarse, Wilson1='cG', Wilson2='cGtil'):
    # read file
    ...
    for entryNum in range(1, limit.GetEntries()):
        ...
        # wcs.append(getattr(limit, f'k_{Wilson}')) # python3
        wcs.append(getattr(limit, 'k_'+Wilson)) # python (2.x)
...
if __name__=='__main__':
    ...
    parser.add_argument('-W1', '--Wilson1', help='Which Wilson coefficient is first? ["cG" (default), "cGtil", ... ]')
    parser.add_argument('-W2', '--Wilson2', help='Which Wilson coefficient is second? ["cGtil" (default), "cG", ... ]')
    ...
    if args.Wilson1 is None:
        args.Wilson1 = "cG"
    if args.Wilson2 is None:
        args.Wilson2 = "cGtil"
    ### check file
    ...
    LL, UL, steps = check_file_threshold_2param(datacard_dir, args.File, args.ThresholdDeltaNLL, args.StepSize, args.StepSizeCoarse, args.Wilson1, args.Wilson2)
