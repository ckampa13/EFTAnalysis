...
# generic function
def update_func(WC, channel, subchannel, ddir, fname):
...
def update_channel_subchannels(channel, version, datacard_dict, WC, ScanType):
    dcdir = datacard_dir
    ...
    for i, subch in enumerate(subchannels):
        ...
        update_func(WC, channel, subch, dir_, tfile)
    print()
...
if __name__=='__main__':
    ...
    for channel in datacard_dict.keys():
        ...
        VERSION = f'v{v}'
        update_channel_subchannels(channel, VERSION, datacard_dict, WC=args.WC, ScanType=args.ScanType)
    print('=================================================\n')
    #########################
