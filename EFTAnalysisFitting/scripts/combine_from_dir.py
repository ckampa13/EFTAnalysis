...
if __name__=='__main__':
    ...
    for dc_base in dc_base_list:
        ...
        # _ = subprocess.run(f'combine -M MultiDimFit {workspacefile} --algo=grid --points 201 --alignEdges 1 {asi_str} --redefineSignalPOIs k_cG --freezeParameters r --setParameters r=1 --setParameterRanges k_cG=-100,100 --verbose -1 -n _{cardfile_base}_coarse', stdout=stdout, shell=True)
