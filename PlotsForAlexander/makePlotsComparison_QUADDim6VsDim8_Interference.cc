...
void makePlots_BW()
{
  ...
  double lumi = 137.0;
  double onshell_crosssection = 0.00224256306801*1000.0;//(0.112788441+0.00224256306801)*1000.0;
  double onshell_crosssection_int = 0.000867438234*2.0*1000.0; 
  ...
  TFile* fileOnshellAll = new TFile("test_unweighted_events_DoubleInsertion_WWW_Interference.root");
  ...
  TFile* fileOnshellBSM = new TFile("test_unweighted_events_WWW_OnShell_Interference_DSC1_Comparison.root");
  ...
  TL.DrawLatexNDC(0.2,0.70,("Interference"));
