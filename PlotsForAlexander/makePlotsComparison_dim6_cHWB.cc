...
void makePlots_BW()
{
  ...
  double lumi = 137.0;
  double onshell_crosssection =  0.0777669628521*1000.0;//0.482086643454*1000.0;
  double onshell_crosssection_int = 0.00113380967846*1000.0;//0.0113714476406*1000.0; 
  double onshell_crosssection_bsm = 0.00882216245354*1000.0;//0.891326097209*1000.0; //0.0068372*1000.0;//0.007216*1000.0
  double onshell_crosssection_sm = 0.073458606*1000.0; 

  TFile* filedim6All = new TFile("test_unweighted_events_WWW_dim6_cHWB_10_All.root");
  ...
  TFile* filedim6Interference = new TFile("test_unweighted_events_WWW_dim6_cHWB_10_Interference.root");
  ...
  TFile* filedim6BSM = new TFile("test_unweighted_events_WWW_dim6_cHWB_10_BSM.root");
  ...
  leg1->SetFillStyle(0);
  leg1->SetHeader("C_{HWB}/#Lambda^{2} = 10 TeV^{-2}");
  ...
  c1.SaveAs("WWW_dim6_cHWB_10_simpleComparison.png");
  c1.SaveAs("WWW_dim6_cHWB_10_simpleComparison.pdf");
}
