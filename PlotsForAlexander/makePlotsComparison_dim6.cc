...
void makePlots_BW()
{
  ...
  double lumi = 137.0;
  double onshell_crosssection = 4.14803201957*1000.0;
  double onshell_crosssection_int = -0.00293641151798*1000.0; 
  double onshell_crosssection_bsm = 4.07342981856*1000.0; //0.0068372*1000.0;//0.007216*1000.0
  double onshell_crosssection_sm = 0.073458606*1000.0; 

  TFile* filedim6All = new TFile("test_unweighted_events_WWW_dim6_All.root");
  ...
  TFile* filedim6Interference = new TFile("test_unweighted_events_WWW_dim6_Interference.root");
  ...
  TFile* filedim6BSM = new TFile("test_unweighted_events_WWW_dim6_BSM.root");
  ...
  leg1->SetFillStyle(0);
  leg1->SetHeader("C_{w}/#Lambda^{4} = 5 TeV^{-2}");
  ...
  c1.SaveAs("WWW_dim6_simpleComparison.png");
  c1.SaveAs("WWW_dim6_simpleComparison.pdf");
}
