...
void makePlots_BW()
{
  ...
  double lumi = 137.0;
  double onshell_crosssection = 0.1977661194*1000.0;
  //double onshell_crosssection_int = 0.000867438234*1000.0; 
  double onshell_crosssection_bsm = 0.0072163*30*1000.0; //0.0068372*1000.0;//0.007216*1000.0
  ...
  leg1->SetFillStyle(0);
  leg1->SetHeader("#splitline{c_{W}/#Lambda^{2} = 1 TeV^{-2} and}{F_{T0}/#Lambda^{4} = 1 TeV^{-4}}");
  ...
  c1.SaveAs("mass_elnu_BW_simpleComparison_QUADDim6VsDim8_cW1.png");
  c1.SaveAs("mass_elnu_BW_simpleComparison_QUADDim6VsDim8_cW1.pdf");
}
