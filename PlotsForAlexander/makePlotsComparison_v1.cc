...
void makePlots_BW()
{
  ...
  double lumi = 137.0;
  double onshell_crosssection = 0.116941482*1000.0;
  double onshell_crosssection_int = 0.000812989206*1000.0; 
  double onshell_crosssection_bsm = 0.0068372*1000.0;//0.007216*1000.0;//0.0068372*1000.0;
  double onshell_crosssection_sm = 0.112643364*1000.0; 

  TFile* fileOnshellAll = new TFile("test_unweighted_events_WWW_Onshell_All_DC1.root");
  ...
  TFile* fileOnshellInterference = new TFile("test_unweighted_events_WWW_Onshell_Interference_DC1.root");
  ...
  TFile* fileOnshellSM = new TFile("test_unweighted_events_WWW_Onshell_SM_DC1.root");
  ...
  c1.SaveAs("mass_3W_DC1_ForPietro.png");
  c1.SaveAs("mass_3W_DC1_ForPietro.pdf");
}
