...
//---------------------------------------------------------------------------------
/*                  Cut_5Lep_Preselection*/   Cut_5Lep_Preselection_branch = tree->GetBranch("Cut_5Lep_Preselection");
/*                  Cut_5Lep_Preselection*/   if (Cut_5Lep_Preselection_branch) Cut_5Lep_Preselection_branch->SetAddress(&Cut_5Lep_Preselection_);
//---------------------------------------------------------------------------------
  tree->SetMakeClass(0);
}
...
/*                         Var_4LepMET_mt2*/  Var_4LepMET_mt2_isLoaded = false;
//---------------------------------------------------------------------------------
/*                   Cut_5Lep_Preselection*/  Cut_5Lep_Preselection_isLoaded = false;
//---------------------------------------------------------------------------------
}
...
//---------------------------------------------------------------------------------
/*                Cut_5Lep_Preselection*/    if (Cut_5Lep_Preselection_branch != 0) Cut_5Lep_Preselection();
//---------------------------------------------------------------------------------
}
...
/*                         Var_4LepMET_mt2*/}
//---------------------------------------------------------------------------------
/*                Cut_5Lep_Preselection*/const bool &VVVTree::Cut_5Lep_Preselection() {
/*                Cut_5Lep_Preselection*/  if (not Cut_5Lep_Preselection_isLoaded) {
/*                Cut_5Lep_Preselection*/    if (Cut_5Lep_Preselection_branch != 0) {
/*                Cut_5Lep_Preselection*/      Cut_5Lep_Preselection_branch->GetEntry(index);
/*                Cut_5Lep_Preselection*/    } else {
/*                Cut_5Lep_Preselection*/      printf("branch Cut_5Lep_Preselection_branch does not exist!\n");
/*                Cut_5Lep_Preselection*/      exit(1);
/*                Cut_5Lep_Preselection*/    }
/*                Cut_5Lep_Preselection*/    Cut_5Lep_Preselection_isLoaded = true;
/*                Cut_5Lep_Preselection*/  }
/*                Cut_5Lep_Preselection*/  return Cut_5Lep_Preselection_;
/*                Cut_5Lep_Preselection*/}
...
//---------------------------------------------------------------------------------
/*                   Cut_5Lep_Preselection*/const bool &Cut_5Lep_Preselection() { return vvv.Cut_5Lep_Preselection(); }
//---------------------------------------------------------------------------------
}
