...
void Process_6Lep()
{
    ...
    // This is where one sets the variables used for the category 6l.
    //==============================================
    ...
    //ana.tx.setBranch<int>("6l_intVar1", -999);
    //ana.tx.setBranch<float>("6l_floatVar1", -999);
    ...
    //LorentzVector LV_6Lep_LVVar1 = RooUtil::Calc::getLV(34.5, 1.2, 3.123, 0.105); // RooUtil::Calc::getLV() creates 4 vector

    //ana.tx.setBranch<LorentzVector>("6l_LVVar1", LV_6Lep_LVVar1);
}

void PostProcess_6Lep(){
    if (ana.cutflow.getCut("Cut_6Lep_AllLeps").pass){
                   ana.tx.fill();
    }
}
