...
void Process()
{
    ...
    switch (ana.looperMode)
    {
        ...
        case AnalysisConfig::k5Lep: Process_5Lep(); break;
        case AnalysisConfig::k6Lep: Process_6Lep(); break;
    }
    ...
    if (ana.write_tree)
    {
        switch (ana.looperMode)
        {
            ...
            case AnalysisConfig::k5Lep: PostProcess_5Lep(); break;
            case AnalysisConfig::k6Lep: PostProcess_6Lep(); break;
        }
    }
