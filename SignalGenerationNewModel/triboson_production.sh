...
GRIDPACK=WWW_ScaleST_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.xz
...
if [ "$CopyToEos" ]
then
#eosmkdir /store/user/lpcvvv/ULSignalSamples/WWW_Nofilter/
#echo ${SAMPLE}
#echo ${LEPTONFILTER}
xrdcp -r -f ${STEP5_NAME}.root root://cmseos.fnal.gov//store/user/lpcvvv/ULSignalSamples/WWW_Nofilter/
xrdcp -r -f ${STEP6_NAME}.root root://cmseos.fnal.gov//store/user/lpcvvv/ULSignalSamples/WWW_Nofilter/
fi
